...
data_file 'WEAPONINFO_FILE' 'metas/**/riftedge.meta'
data_file 'WEAPONINFO_FILE' 'metas/**/dildo.meta'
data_file 'WEAPONINFO_FILE' 'metas/**/custom.meta'
data_file 'WEAPONINFO_FILE' 'metas/**/mp9.meta'
data_file 'WEAPONINFO_FILE' 'metas/**/mac10.meta'
data_file 'WEAPONINFO_FILE' 'metas/**/uzi.meta'
data_file 'WEAPONINFO_FILE' 'metas/**/katana.meta'